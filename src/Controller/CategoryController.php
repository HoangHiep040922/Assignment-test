...
//    public function listCategory(ManagerRegistry $doctrine, $id): Response
//    {
...
//    public function viewCategory(int $id, CategoryRepository $categoryRepository): Response
//    {
...
//    {
//        $category_id = $doctrine->getManager();
//        $category = $category_id->getRepository(Category::class)->find($id);
//        $products = $doctrine->getRepository(Product::class)->find($id);
//
//        return $this->render('category/view.html.twig',['products' => $products,'category'=>$category]);
//    }
...
//    }
    ...
    public function detailsCategory(ManagerRegistry $doctrine): Response
    {
