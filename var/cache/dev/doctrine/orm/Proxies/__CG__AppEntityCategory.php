...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'CatName', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'Product'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCatName(?string $CatName): \App\Entity\Category
    {
