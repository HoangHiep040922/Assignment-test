...
class __TwigTemplate_926501fc61aa4b0d636c75a846ec474ec69e8944ae73be35cb7012a7a313fe39 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "</th>
                    <td><a href=\"";
            // line 17
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("productByCat", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 17)]), "html", null, true);
            echo " \">";
            ...
            echo "</a></td>
                    ...
                    <a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("productByCat", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 20)]), "html", null, true);
            echo " \" class='btn btn-success'>View</a>
                        <a href=\"#\" class='btn btn-default'>Edit</a>
                        <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 22)]), "html", null, true);
...
";
    ...
    {
        return array (  192 => 61,  182 => 57,  178 => 56,  174 => 55,  169 => 53,  165 => 52,  161 => 51,  157 => 50,  153 => 49,  149 => 48,  145 => 47,  141 => 46,  138 => 45,  134 => 44,  114 => 26,  104 => 22,  99 => 20,  91 => 17,  87 => 16,  84 => 15,  80 => 14,  68 => 4,  58 => 3,  35 => 1,);
    }
        ...
        <table class=\"table table-striped\">
            ...
            {% for category in categories %}
                <tr>
                    ...
                    <td><a href=\"{{path('productByCat',{'id':category.id})}} \">{{ category.catname }}</a></td>

                    <td>
                    <a href=\"{{path('productByCat',{'id':category.id})}} \" class='btn btn-success'>View</a>
                        <a href=\"#\" class='btn btn-default'>Edit</a>
                        <a href=\"{{ path('product_delete', {'id': category.id}) }} \"class='btn btn-danger'>Delete</a>
                    </td>
                </tr>
            {% endfor %}
            </tbody>
...
{% endblock %}
", "category/index.html.twig", "C:\\Users\\Kair\\Assignment\\templates\\category\\index.html.twig");
    }
}
